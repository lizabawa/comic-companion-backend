...
public class ComicServiceTest {
    ...
    public void testGetAllComics() {
        Comic comic1 = new Comic(1L, "Comic 1", "Comic 1 Description", "red-ranger-images/red-ranger.png");
        Comic comic2 = new Comic(2L, "Comic 2", "Comic 2 Description", "red-ranger-images/red-ranger.png");
        Comic comic3 = new Comic(3L, "Comic 3", "Comic 3 Description", "red-ranger-images/red-ranger.png");
